...
datamodule = CIFAR100DataModule(root=root, batch_size=200,eval_ood=True,eval_shift=True,near_ood_datasets=[custom_dataset1],far_ood_datasets=[custom_dataset2])
