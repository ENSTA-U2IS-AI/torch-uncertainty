...
# from lightning.pytorch.utilities import get_model_size_mb
...
class ClassificationRoutine(LightningModule):
    def __init__(
        ...
        Args:
            ...
            calibration_set (Callable | None, optional): _description_. Defaults to None.
        ...
        if self.num_estimators > 1:
            ...
            self.test_id_ens_metrics = ens_metrics.clone(
                prefix="hp/test_id_ens_"
            )
    ...
    def on_train_start(self) -> None:
        ...
        # self.hparams.storage = f"{get_model_size_mb(self)} MB"
    ...
    def validation_step(
        ...
        inputs, targets = batch
        logits = self.forward(inputs)  # (b, c) or (m, b, c)
        if logits.ndim == 2:
    ...
    def on_test_epoch_end(self) -> None:
        ...
        if isinstance(self.logger, TensorBoardLogger) and self.log_plots:
            ...
            # TODO: plot histograms of logits and likelihoods
